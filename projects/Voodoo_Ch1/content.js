...
})(window, mse);var coords = JSON.parse('{"cid0":800,"cid1":600,"cid2":250,"cid3":100,"cid4":300,"cid5":409,"cid6":0,"cid7":-200,"cid8":1090,"cid9":20,"cid10":305,"cid11":46.25,"cid12":342.5,"cid13":35,"cid14":197.5,"cid15":38.75,"cid16":425,"cid17":122.5,"cid18":30,"cid19":190,"cid20":40,"cid21":578.75,"cid22":533.75,"cid23":160,"cid24":27.5,"cid25":601.25,"cid26":543.75,"cid27":13.75,"cid28":400,"cid29":200,"cid30":41.25,"cid31":235,"cid32":108.75,"cid33":32.5,"cid34":177.5,"cid35":320,"cid36":247.5,"cid37":340,"cid38":590,"cid39":230,"cid40":10,"cid41":22.5}');initMseConfig();mse.init();function createbook(){var root = new mse.Root('Voodoo_Ch1',coords.cid0,coords.cid1,'portrait');var temp = {};var animes={};var games={};var wikis={};mse.src.addSource('src0','./images/src0.png','img',true);mse.src.addSource('src1','./images/src1.jpeg','img',true);mse.src.addSource('src2','./images/src2.jpeg','img',true);mse.src.addSource('src3','./images/src3.jpeg','img',true);mse.src.addSource('src4','./images/src4.jpeg','img',true);mse.src.addSource('src5','./projects/Voodoo_Ch1/audios/src5.ogg','aud',false);mse.src.addSource('src6','./images/src6.png','img',true);mse.src.addSource('src7','./images/src7.png','img',true);mse.src.addSource('src8','./images/src8.png','img',true);mse.src.addSource('src9','./images/src9.jpeg','img',true);wikis.Cyclope=new mse.WikiLayer();wikis.Cyclope.addImage('src9', 'Cyclope, super-héros des X-Men');wikis.Cyclope.addImage('src8', 'Polyphème, fils de Poséïdon');wikis.Cyclope.addTextCard();wikis.Cyclope.textCard.addSection('Un Cyclope chez les X-Men', 'Cyclope est aussi un super-héros créé par J. Kirby et S. Lee en 1963. C’est un mutant qui génère des rayons extrêmement puissants avec ses yeux mais il évite au maximum d’utiliser la violence. Il devient un des leaders des X-Men.');wikis.Cyclope.textCard.addSection('Lien', 'http://fr.wikipedia.org/wiki/Cyclope_%28comics%29');wikis.Cyclope.addTextCard();wikis.Cyclope.textCard.addSection('Cyclope', 'Nom, masculin : Les cyclopes sont des créatures fantastiques de la mythologie grecque. Ce sont des géants qui ne possèdent qu’un seul œil au milieu du front. Ils étaient soit forgerons, bâtisseurs ou pasteurs.');wikis.Cyclope.textCard.addLink('Lien', 'http://fr.wikipedia.org/wiki/Cyclope');animes.fouine=new mse.Animation(16,1,1);temp.obj=new mse.Image(null,{'pos':[coords.cid2,coords.cid3],'size':[coords.cid4,coords.cid5]},'src0');animes.fouine.addObj('src0',temp.obj);animes.fouine.addAnimation('src0',{'frame':JSON.parse('[0,1,9,15,16]'),'opacity':JSON.parse('[1,0,1,0,0]'),'pos':[[coords.cid2,coords.cid3],[coords.cid2,coords.cid3],[coords.cid2,coords.cid3],[coords.cid6,coords.cid7],[coords.cid6,coords.cid7]],'size':[[coords.cid4,coords.cid5],[coords.cid4,coords.cid5],[coords.cid4,coords.cid5],[coords.cid0,coords.cid8],[coords.cid0,coords.cid8]]});var pages = {};var layers = {};var objs = {};pages.Couverture=new mse.BaseContainer(root,{size:[coords.cid0,coords.cid1]});layers.back=new mse.Layer(pages.Couverture,1,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj5=new mse.Image(layers.back,{"size":[coords.cid0,coords.cid1],"pos":[coords.cid6,coords.cid6],"fillStyle":"rgb(0, 0, 0)","globalAlpha":1,"font":"normal "+coords.cid9+"px Times","textAlign":"left"},'src3');layers.back.addObject(objs.obj5);pages.Couverture.addLayer('back',layers.back);layers.Couverturedefault=new mse.Layer(pages.Couverture,2,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj2=new mse.Text(layers.Couverturedefault,{"size":[coords.cid10,coords.cid11],"pos":[coords.cid12,coords.cid11],"fillStyle":"rgb(255, 255, 255)","globalAlpha":1,"font":"normal "+coords.cid13+"px Verdanda","textAlign":"left"},'Voodoo Connection',true);layers.Couverturedefault.addObject(objs.obj2);objs.obj3=new mse.Text(layers.Couverturedefault,{"size":[coords.cid14,coords.cid15],"pos":[coords.cid16,coords.cid17],"fillStyle":"rgb(81, 61, 29)","globalAlpha":1,"font":"normal "+coords.cid18+"px Verdanda","textAlign":"left"},'Chris Debien',true);layers.Couverturedefault.addObject(objs.obj3);pages.Couverture.addLayer('Couverturedefault',layers.Couverturedefault);pages.Aide=new mse.BaseContainer(null,{size:[coords.cid0,coords.cid1]});layers.Aidedefault=new mse.Layer(pages.Aide,1,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj6=new mse.Image(layers.Aidedefault,{"size":[coords.cid0,coords.cid1],"pos":[coords.cid6,coords.cid6],"fillStyle":"rgb(0, 0, 0)","globalAlpha":1,"font":"normal "+coords.cid9+"px Times"},'src4');layers.Aidedefault.addObject(objs.obj6);pages.Aide.addLayer('Aidedefault',layers.Aidedefault);layers.button=new mse.Layer(pages.Aide,2,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj566=new mse.Image(layers.button,{"size":[coords.cid19,coords.cid20],"pos":[coords.cid21,coords.cid22],"fillStyle":"rgb(0, 0, 0)","globalAlpha":1,"font":"normal "+coords.cid9+"px Times"},'src7');layers.button.addObject(objs.obj566);pages.Aide.addLayer('button',layers.button);layers.text=new mse.Layer(pages.Aide,3,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj9=new mse.Text(layers.text,{"size":[coords.cid23,coords.cid24],"pos":[coords.cid25,coords.cid26],"fillStyle":"rgb(255, 255, 255)","globalAlpha":1,"font":"normal "+coords.cid27+"px Verdana","textAlign":"left"},'Commencer l\'histoire',true);layers.text.addObject(objs.obj9);pages.Aide.addLayer('text',layers.text);pages.Chapitre=new mse.BaseContainer(null,{size:[coords.cid0,coords.cid1]});layers.Chapitredefault=new mse.Layer(pages.Chapitre,1,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj10=new mse.Image(layers.Chapitredefault,{"size":[coords.cid6,coords.cid6],"pos":[coords.cid6,coords.cid6]},'src2');layers.Chapitredefault.addObject(objs.obj10);objs.obj11=new mse.Image(layers.Chapitredefault,{"size":[coords.cid0,coords.cid1],"pos":[coords.cid6,coords.cid6]},'src2');layers.Chapitredefault.addObject(objs.obj11);objs.obj12=new mse.Mask(layers.Chapitredefault,{"size":[coords.cid28,coords.cid1],"pos":[coords.cid29,coords.cid6],"fillStyle":"rgb(0, 0, 0)","globalAlpha":0.80,"font":"normal "+coords.cid9+"px Times"});layers.Chapitredefault.addObject(objs.obj12);pages.Chapitre.addLayer('Chapitredefault',layers.Chapitredefault);layers.Text=new mse.Layer(pages.Chapitre,2,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj13=new mse.Text(layers.Text,{"size":[coords.cid12,coords.cid30],"pos":[coords.cid31,coords.cid32],"fillStyle":"rgb(255, 255, 255)","globalAlpha":1,"font":"normal "+coords.cid33+"px Verdana","textAlign":"left"},'CHASSE A L\'HOMME',true);layers.Text.addObject(objs.obj13);objs.obj14=new mse.Text(layers.Text,{"size":[coords.cid34,coords.cid11],"pos":[coords.cid35,coords.cid36],"fillStyle":"rgb(255, 255, 255)","globalAlpha":1,"font":"normal "+coords.cid33+"px Verdana","textAlign":"left"},'Chapitre I',true);layers.Text.addObject(objs.obj14);pages.Chapitre.addLayer('Text',layers.Text);pages.Content=new mse.BaseContainer(null,{size:[coords.cid0,coords.cid1]});layers.Contentdefault=new mse.Layer(pages.Content,1,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj15=new mse.Image(layers.Contentdefault,{"size":[coords.cid0,coords.cid1],"pos":[coords.cid6,coords.cid6]},'src2');layers.Contentdefault.addObject(objs.obj15);pages.Content.addLayer('Contentdefault',layers.Contentdefault);layers.mask=new mse.Layer(pages.Content,2,{"globalAlpha":1,"size":[coords.cid0,coords.cid1]});objs.obj16=new mse.Mask(layers.mask,{"size":[coords.cid28,coords.cid1],"pos":[coords.cid29,coords.cid6],"fillStyle":"rgb(0, 0, 0)","globalAlpha":0.80,"font":"normal "+coords.cid9+"px Times","textAlign":"left"});layers.mask.addObject(objs.obj16);pages.Content.addLayer('mask',layers.mask);layers.content=new mse.ArticleLayer(pages.Content,3,{"size":[coords.cid37,coords.cid38],"pos":[coords.cid39,coords.cid40],"fillStyle":"rgb(255, 255, 255)","globalAlpha":1,"font":"normal "+coords.cid41+"px Verdana","textAlign":"left","textBaseline":"top","lineHeight":coords.cid18},null);objs.obj17=new mse.UIObject(layers.content,{"fillStyle":"initial"});layers.content.addObject(objs.obj17);objs.obj18=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Ils étaient là. ',true);layers.content.addObject(objs.obj18);objs.obj19=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'À moins de cent mètres ',true);layers.content.addObject(objs.obj19);objs.obj20=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'derrière Simon. Bien décidés ',true);layers.content.addObject(objs.obj20);objs.obj21=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'à lui faire payer l’affront ',true);layers.content.addObject(objs.obj21);objs.obj22=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'qu’ils avaient subi. ',true);layers.content.addObject(objs.obj22);objs.obj23=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'La Meute. ',true);layers.content.addObject(objs.obj23);objs.obj24=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Quatre adolescents qui ',true);layers.content.addObject(objs.obj24);objs.obj25=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'faisaient régner leur loi au ',true);layers.content.addObject(objs.obj25);objs.obj26=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'sein du foyer.',true);objs.obj26.addLink(new mse.Link('foyer',9,'fb','http://www.facebook.com/pages/La-mort-ne-porte-pas-de-rouge-%C3%A0-l%C3%A8vres/363418027009563'));layers.content.addObject(objs.obj26);objs.obj27=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Recroquevillé dans la ',true);layers.content.addObject(objs.obj27);objs.obj28=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'pénombre d’un porche, ',true);layers.content.addObject(objs.obj28);objs.obj29=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'L’adolescent contemplait le ',true);layers.content.addObject(objs.obj29);objs.obj30=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ballet des lampes torches qui ',true);layers.content.addObject(objs.obj30);objs.obj31=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'déchiraient la nuit. Des ',true);layers.content.addObject(objs.obj31);objs.obj32=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'yeux, scrutant le moindre ',true);layers.content.addObject(objs.obj32);objs.obj33=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'recoin, repoussant les ',true);layers.content.addObject(objs.obj33);objs.obj34=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ténèbres de leurs lueurs ',true);layers.content.addObject(objs.obj34);objs.obj35=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'cyclopes. ',true);objs.obj35.addLink(new mse.Link('cyclopes',18,'wiki',wikis.Cyclope));layers.content.addObject(objs.obj35);objs.obj36=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Bientôt, ils seraient sur lui. ',true);layers.content.addObject(objs.obj36);objs.obj37=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon frissonna en songeant ',true);layers.content.addObject(objs.obj37);objs.obj38=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'à ce qui allait lui arriver. Il ',true);layers.content.addObject(objs.obj38);objs.obj39=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'savait que Kevin, leur chef, ',true);layers.content.addObject(objs.obj39);objs.obj40=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'serait sans pitié…  ',true);layers.content.addObject(objs.obj40);objs.obj41=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il fallait qu’il leur échappe.',true);layers.content.addObject(objs.obj41);objs.obj42=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Absolument. Et tant pis s’il ',true);layers.content.addObject(objs.obj42);objs.obj43=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ne pouvait jamais retourner ',true);layers.content.addObject(objs.obj43);objs.obj44=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'au foyer.',true);layers.content.addObject(objs.obj44);objs.obj45=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Les pas se rapprochaient, de ',true);layers.content.addObject(objs.obj45);objs.obj46=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'plus en plus. Il pouvait ',true);layers.content.addObject(objs.obj46);objs.obj47=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'entendre leurs voix à ',true);layers.content.addObject(objs.obj47);objs.obj48=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'présent.',true);layers.content.addObject(objs.obj48);objs.obj49=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Trouvez-moi ce sale petit ',true);layers.content.addObject(objs.obj49);objs.obj50=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'rat ! Il va comprendre qu’on ',true);layers.content.addObject(objs.obj50);objs.obj51=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ne peut pas se moquer de ',true);layers.content.addObject(objs.obj51);objs.obj52=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'nous comme ça !',true);layers.content.addObject(objs.obj52);objs.obj53=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Ouaip, on va lui faire sa ',true);layers.content.addObject(objs.obj53);objs.obj54=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'fête !',true);layers.content.addObject(objs.obj54);objs.obj55=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Ca, c’était « La Fouine ». ',true);layers.content.addObject(objs.obj55);objs.obj56=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Dix sept ans, un mètre ',true);layers.content.addObject(objs.obj56);objs.obj57=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'quatre-vingt, ',true);layers.content.addObject(objs.obj57);objs.obj58=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'soixante-quinze kilos de ',true);layers.content.addObject(objs.obj58);objs.obj59=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'violence pure. Une véritable ',true);layers.content.addObject(objs.obj59);objs.obj60=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bombe ambulante qui ne ',true);layers.content.addObject(objs.obj60);objs.obj61=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'demandait qu’à exploser. ',true);layers.content.addObject(objs.obj61);objs.obj62=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon se pencha un instant ',true);layers.content.addObject(objs.obj62);objs.obj63=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'hors de son abri pour ',true);layers.content.addObject(objs.obj63);objs.obj64=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'évaluer ses chances de leur ',true);layers.content.addObject(objs.obj64);objs.obj65=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'échapper. ',true);layers.content.addObject(objs.obj65);objs.obj66=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Proche du zéro absolu s’il ne ',true);layers.content.addObject(objs.obj66);objs.obj67=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bougeait pas de sa cachette. ',true);layers.content.addObject(objs.obj67);objs.obj68=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Un peu plus s’il tentait une ',true);layers.content.addObject(objs.obj68);objs.obj69=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'sortie. À condition de tomber ',true);layers.content.addObject(objs.obj69);objs.obj70=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'sur quelqu’un, un adulte qui ',true);layers.content.addObject(objs.obj70);objs.obj71=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'saurait éloigner ses ',true);layers.content.addObject(objs.obj71);objs.obj72=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'poursuivants. ',true);layers.content.addObject(objs.obj72);objs.obj73=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Tu es prêt ? chuchota-t-il ',true);layers.content.addObject(objs.obj73);objs.obj74=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'à Dark.',true);layers.content.addObject(objs.obj74);objs.obj75=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Dark. Vador. Son rat albinos. ',true);layers.content.addObject(objs.obj75);objs.obj76=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Son plus fidèle compagnon ',true);layers.content.addObject(objs.obj76);objs.obj77=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'depuis un an. ',true);layers.content.addObject(objs.obj77);objs.obj78=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Le seul en vérité. ',true);layers.content.addObject(objs.obj78);objs.obj79=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon repoussa l’élan de ',true);layers.content.addObject(objs.obj79);objs.obj80=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'mélancolie qui menaçait de ',true);layers.content.addObject(objs.obj80);objs.obj81=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'le submerger et enfouit Dark ',true);layers.content.addObject(objs.obj81);objs.obj82=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'au fond de son sac. Il passa ',true);layers.content.addObject(objs.obj82);objs.obj83=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'les lanières autour de ses ',true);layers.content.addObject(objs.obj83);objs.obj84=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'épaules et s’élança. ',true);layers.content.addObject(objs.obj84);objs.obj85=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Pas de réaction.',true);layers.content.addObject(objs.obj85);objs.obj86=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il s’était mis à courir comme ',true);layers.content.addObject(objs.obj86);objs.obj87=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'si sa vie en dépendait. ',true);layers.content.addObject(objs.obj87);objs.obj88=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Si la « Meute » lui tombait ',true);layers.content.addObject(objs.obj88);objs.obj89=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dessus, il était bon pour un ',true);layers.content.addObject(objs.obj89);objs.obj90=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'passage à tabac dans les ',true);layers.content.addObject(objs.obj90);objs.obj91=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'règles de l’art. Voilà ce qui ',true);layers.content.addObject(objs.obj91);objs.obj92=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'se passe lorsque l’on refuse ',true);layers.content.addObject(objs.obj92);objs.obj93=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de soumettre aux plus forts.',true);layers.content.addObject(objs.obj93);objs.obj94=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon évitait de regarder ',true);layers.content.addObject(objs.obj94);objs.obj95=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dans leur direction, les yeux ',true);layers.content.addObject(objs.obj95);objs.obj96=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'rivés sur les frondaisons du ',true);layers.content.addObject(objs.obj96);objs.obj97=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Parc Montsouris. Des arbres, ',true);layers.content.addObject(objs.obj97);objs.obj98=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de la pénombre et des ',true);layers.content.addObject(objs.obj98);objs.obj99=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'milliards de recoins où il ',true);layers.content.addObject(objs.obj99);objs.obj100=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'pourrait se dissimuler en ',true);layers.content.addObject(objs.obj100);objs.obj101=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'attendant l’aube. ',true);layers.content.addObject(objs.obj101);objs.obj102=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'S’il atteignait le jardin, il ',true);layers.content.addObject(objs.obj102);objs.obj103=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'serait sauvé.',true);layers.content.addObject(objs.obj103);objs.obj104=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Mais, dans sa précipitation, il ',true);layers.content.addObject(objs.obj104);objs.obj105=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'butta contre le trottoir. Le ',true);layers.content.addObject(objs.obj105);objs.obj106=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'béton lui arracha une ',true);layers.content.addObject(objs.obj106);objs.obj107=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'plainte. Un cri minuscule.',true);layers.content.addObject(objs.obj107);objs.obj108=new mse.UIObject(layers.content,{"fillStyle":"initial"});layers.content.addObject(objs.obj108);objs.obj109=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Il est là !',true);layers.content.addObject(objs.obj109);objs.obj110=new mse.UIObject(layers.content,{"fillStyle":"initial"});layers.content.addObject(objs.obj110);objs.obj111=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Pas assez minuscule, ',true);layers.content.addObject(objs.obj111);objs.obj112=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'visiblement.',true);layers.content.addObject(objs.obj112);objs.obj113=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon détala tandis que les ',true);layers.content.addObject(objs.obj113);objs.obj114=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'faisceaux accrochaient sa ',true);layers.content.addObject(objs.obj114);objs.obj115=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'silhouette. ',true);layers.content.addObject(objs.obj115);objs.obj116=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Choppez-le ! Faut qu’il ',true);layers.content.addObject(objs.obj116);objs.obj117=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'comprenne !',true);layers.content.addObject(objs.obj117);objs.obj118=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Que je comprenne quoi ? ',true);layers.content.addObject(objs.obj118);objs.obj119=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Qu’il faut se laisser faire ? ',true);layers.content.addObject(objs.obj119);objs.obj120=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Pas question !',true);layers.content.addObject(objs.obj120);objs.obj121=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il accéléra. ',true);layers.content.addObject(objs.obj121);objs.obj122=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il essayait d’oublier que ses ',true);layers.content.addObject(objs.obj122);objs.obj123=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'poumons le brûlaient, qu’il ',true);layers.content.addObject(objs.obj123);objs.obj124=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'était épuisé par cette ',true);layers.content.addObject(objs.obj124);objs.obj125=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'poursuite qui durait depuis ',true);layers.content.addObject(objs.obj125);objs.obj126=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'des heures, et surtout que la ',true);layers.content.addObject(objs.obj126);objs.obj127=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'peur menaçait de le ',true);layers.content.addObject(objs.obj127);objs.obj128=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'paralyser à tout instant. ',true);layers.content.addObject(objs.obj128);objs.obj129=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il traversa le boulevard, ',true);layers.content.addObject(objs.obj129);objs.obj130=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'déclenchant le klaxon ',true);layers.content.addObject(objs.obj130);objs.obj131=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'furieux d’un noctambule ',true);layers.content.addObject(objs.obj131);objs.obj132=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'égaré. Puis il s’engouffra à ',true);layers.content.addObject(objs.obj132);objs.obj133=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'l’abri des arbres. Son sac ',true);layers.content.addObject(objs.obj133);objs.obj134=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ballotait sur ses épaules et il ',true);layers.content.addObject(objs.obj134);objs.obj135=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'pensa au pauvre Dark. ',true);layers.content.addObject(objs.obj135);objs.obj136=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Sans réfléchir, il pénétra ',true);layers.content.addObject(objs.obj136);objs.obj137=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dans une petite allée. Il ',true);layers.content.addObject(objs.obj137);objs.obj138=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dépassa les angles du ',true);layers.content.addObject(objs.obj138);objs.obj139=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'pavillon météo qui s’élevait ',true);layers.content.addObject(objs.obj139);objs.obj140=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dans la pénombre, puis il ',true);layers.content.addObject(objs.obj140);objs.obj141=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ralentit sa course. ',true);layers.content.addObject(objs.obj141);objs.obj142=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Pas un bruit.',true);layers.content.addObject(objs.obj142);objs.obj143=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Rien d’autre que le vent ',true);layers.content.addObject(objs.obj143);objs.obj144=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'dans les feuilles. ',true);layers.content.addObject(objs.obj144);objs.obj145=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Où étaient-ils passés ?',true);layers.content.addObject(objs.obj145);objs.obj146=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon s’arrêta, s’accroupit ',true);layers.content.addObject(objs.obj146);objs.obj147=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'derrière un banc scarifié de ',true);layers.content.addObject(objs.obj147);objs.obj148=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'graffitis. ',true);layers.content.addObject(objs.obj148);objs.obj149=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Là ! Sur sa gauche. ',true);layers.content.addObject(objs.obj149);objs.obj150=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il avait reconnu la démarche ',true);layers.content.addObject(objs.obj150);objs.obj151=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'chaloupée de la Fouine, les ',true);layers.content.addObject(objs.obj151);objs.obj152=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'pas lourds de l’Ours – seize ',true);layers.content.addObject(objs.obj152);objs.obj153=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ans, un QI inversement ',true);layers.content.addObject(objs.obj153);objs.obj154=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'proportionnel à sa force - à ',true);layers.content.addObject(objs.obj154);objs.obj155=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ses côtés. Les deux autres ',true);layers.content.addObject(objs.obj155);objs.obj156=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'suivaient la ligne de ',true);layers.content.addObject(objs.obj156);objs.obj157=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'tramway qui longeait le parc, ',true);layers.content.addObject(objs.obj157);objs.obj158=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'sur sa droite.',true);layers.content.addObject(objs.obj158);objs.obj159=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Le groupe s’était séparé en ',true);layers.content.addObject(objs.obj159);objs.obj160=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'deux et tentait de ',true);layers.content.addObject(objs.obj160);objs.obj161=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'l’encercler.',true);layers.content.addObject(objs.obj161);objs.obj162=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon réfléchit à toute ',true);layers.content.addObject(objs.obj162);objs.obj163=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'allure. ',true);layers.content.addObject(objs.obj163);objs.obj164=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Le RER ! ',true);layers.content.addObject(objs.obj164);objs.obj165=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'La station ne devait être ',true);layers.content.addObject(objs.obj165);objs.obj166=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'qu’à quelques dizaines de ',true);layers.content.addObject(objs.obj166);objs.obj167=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'mètres devant lui et, même ',true);layers.content.addObject(objs.obj167);objs.obj168=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'en ces heures tardives, il y ',true);layers.content.addObject(objs.obj168);objs.obj169=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'aurait sans doute un peu de ',true);layers.content.addObject(objs.obj169);objs.obj170=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'monde. ',true);layers.content.addObject(objs.obj170);objs.obj171=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il reprit sa progression, ',true);layers.content.addObject(objs.obj171);objs.obj172=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'lentement, veillant à rester ',true);layers.content.addObject(objs.obj172);objs.obj173=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'invisible. ',true);layers.content.addObject(objs.obj173);objs.obj174=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Plus que cinquante mètres.',true);layers.content.addObject(objs.obj174);objs.obj175=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il entendait déjà le ',true);layers.content.addObject(objs.obj175);objs.obj176=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'crissement des rames sur les ',true);layers.content.addObject(objs.obj176);objs.obj177=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'rails.',true);layers.content.addObject(objs.obj177);objs.obj178=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Quarante.',true);layers.content.addObject(objs.obj178);objs.obj179=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Là sur le pont ! Il essaye ',true);layers.content.addObject(objs.obj179);objs.obj180=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de rejoindre la gare !',true);layers.content.addObject(objs.obj180);objs.obj181=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Merde ! lâcha Simon en ',true);layers.content.addObject(objs.obj181);objs.obj182=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'reprenant sa course.',true);layers.content.addObject(objs.obj182);objs.obj183=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Trente.',true);layers.content.addObject(objs.obj183);objs.obj184=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Mais la meute, galvanisée ',true);layers.content.addObject(objs.obj184);objs.obj185=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'par la proximité de sa proie, ',true);layers.content.addObject(objs.obj185);objs.obj186=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'se rapprochait rapidement. ',true);layers.content.addObject(objs.obj186);objs.obj187=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Ils avaient de la lumière, ils ',true);layers.content.addObject(objs.obj187);objs.obj188=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'évitaient les obstacles. ',true);layers.content.addObject(objs.obj188);objs.obj189=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Surtout ils étaient plus âgés, ',true);layers.content.addObject(objs.obj189);objs.obj190=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'plus forts alors que lui était ',true);layers.content.addObject(objs.obj190);objs.obj191=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'éreinté, les jambes ',true);layers.content.addObject(objs.obj191);objs.obj192=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'écorchées par les ronces, au ',true);layers.content.addObject(objs.obj192);objs.obj193=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bord de l’asphyxie.',true);layers.content.addObject(objs.obj193);objs.obj194=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Les deux groupes gagnaient ',true);layers.content.addObject(objs.obj194);objs.obj195=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'insensiblement du terrain. ',true);layers.content.addObject(objs.obj195);objs.obj196=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Bientôt ils se rejoindraient et ',true);layers.content.addObject(objs.obj196);objs.obj197=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ce serait l’hallali.',true);layers.content.addObject(objs.obj197);objs.obj198=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon obliqua brutalement ',true);layers.content.addObject(objs.obj198);objs.obj199=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'vers le nord pour essayer de ',true);layers.content.addObject(objs.obj199);objs.obj200=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'rejoindre un bouquet ',true);layers.content.addObject(objs.obj200);objs.obj201=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'d’arbres denses. Avec un ',true);layers.content.addObject(objs.obj201);objs.obj202=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'peu de chance, il pourrait les ',true);layers.content.addObject(objs.obj202);objs.obj203=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'semer. Au pire, il grimperait ',true);layers.content.addObject(objs.obj203);objs.obj204=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'sur l’un des troncs ',true);layers.content.addObject(objs.obj204);objs.obj205=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'centenaires. ',true);layers.content.addObject(objs.obj205);objs.obj206=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il se précipita dans le ',true);layers.content.addObject(objs.obj206);objs.obj207=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bosquet. Les branches ',true);layers.content.addObject(objs.obj207);objs.obj208=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'basses fouettèrent son ',true);layers.content.addObject(objs.obj208);objs.obj209=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'visage, lui arrachant des ',true);layers.content.addObject(objs.obj209);objs.obj210=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'larmes. ',true);layers.content.addObject(objs.obj210);objs.obj211=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Mais il était presqu’à l’abri : ',true);layers.content.addObject(objs.obj211);objs.obj212=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'l’obscurité était totale. ',true);layers.content.addObject(objs.obj212);objs.obj213=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il ignorait vers quoi il ',true);layers.content.addObject(objs.obj213);objs.obj214=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'courrait mais il s’en fichait. ',true);layers.content.addObject(objs.obj214);objs.obj215=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il accéléra encore et…',true);layers.content.addObject(objs.obj215);objs.obj216=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'S’effondra brutalement, le ',true);layers.content.addObject(objs.obj216);objs.obj217=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'souffle coupé, une violente ',true);layers.content.addObject(objs.obj217);objs.obj218=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'douleur barrant sa poitrine. ',true);layers.content.addObject(objs.obj218);objs.obj219=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il venait de heurter quelque ',true);layers.content.addObject(objs.obj219);objs.obj220=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'chose de plein fouet. ',true);layers.content.addObject(objs.obj220);objs.obj221=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Abasourdi, Simon fouilla ',true);layers.content.addObject(objs.obj221);objs.obj222=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'l’obscurité. Il entendait ses ',true);layers.content.addObject(objs.obj222);objs.obj223=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'poursuivants battre les talus ',true);layers.content.addObject(objs.obj223);objs.obj224=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'et les fourrés. ',true);layers.content.addObject(objs.obj224);objs.obj225=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il tâtonna un instant dans ',true);layers.content.addObject(objs.obj225);objs.obj226=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'son sac. ',true);layers.content.addObject(objs.obj226);objs.obj227=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Sa torche.',true);layers.content.addObject(objs.obj227);objs.obj228=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Un faible halo de lumière.',true);layers.content.addObject(objs.obj228);objs.obj229=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Un grillage. ',true);layers.content.addObject(objs.obj229);objs.obj230=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Piégé !',true);layers.content.addObject(objs.obj230);objs.obj231=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il se redressa en grimaçant, ',true);layers.content.addObject(objs.obj231);objs.obj232=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'s’approcha.  ',true);layers.content.addObject(objs.obj232);objs.obj233=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Une dizaine de mètres en ',true);layers.content.addObject(objs.obj233);objs.obj234=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'contrebas, le faisceau de sa ',true);layers.content.addObject(objs.obj234);objs.obj235=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'lampe illumina les reliefs ',true);layers.content.addObject(objs.obj235);objs.obj236=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'mangés de rouille d’une ',true);layers.content.addObject(objs.obj236);objs.obj237=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ligne de chemin de fer ',true);layers.content.addObject(objs.obj237);objs.obj238=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'abandonnée.',true);layers.content.addObject(objs.obj238);objs.obj239=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'La Petite Ceinture. ',true);layers.content.addObject(objs.obj239);objs.obj240=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Un éclat de voix derrière lui ',true);layers.content.addObject(objs.obj240);objs.obj241=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'le fit sursauter.',true);layers.content.addObject(objs.obj241);objs.obj242=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - On le tient !',true);layers.content.addObject(objs.obj242);objs.obj243=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon fixa le puits de ',true);layers.content.addObject(objs.obj243);objs.obj244=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'ténèbres qui s’étendait ',true);layers.content.addObject(objs.obj244);objs.obj245=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'au-delà du grillage.',true);layers.content.addObject(objs.obj245);objs.obj246=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Alors, t’es enfin prêt à ',true);layers.content.addObject(objs.obj246);objs.obj247=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'recevoir ta leçon ?',true);layers.content.addObject(objs.obj247);objs.obj248=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Kevin s’approcha dans la ',true);layers.content.addObject(objs.obj248);objs.obj249=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'clarté de la lune. Il tendit le ',true);layers.content.addObject(objs.obj249);objs.obj250=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bras. Un bruit de ressort. ',true);layers.content.addObject(objs.obj250);objs.obj251=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Une lame apparut au bout ',true);layers.content.addObject(objs.obj251);objs.obj252=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de sa main. ',true);layers.content.addObject(objs.obj252);objs.obj253=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'L’adolescent sentait le sang ',true);layers.content.addObject(objs.obj253);objs.obj254=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'battre contre ses tempes, ',true);layers.content.addObject(objs.obj254);objs.obj255=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'l’adrénaline inonder son ',true);layers.content.addObject(objs.obj255);objs.obj256=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'corps. Il voulait gagner du ',true);layers.content.addObject(objs.obj256);objs.obj257=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'temps pour récupérer. Pour ',true);layers.content.addObject(objs.obj257);objs.obj258=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'tenter quelque chose. ',true);layers.content.addObject(objs.obj258);objs.obj259=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il se retourna face à ses ',true);layers.content.addObject(objs.obj259);objs.obj260=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'adversaires.',true);layers.content.addObject(objs.obj260);objs.obj261=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Je n’ai fait que défendre ',true);layers.content.addObject(objs.obj261);objs.obj262=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Rachel. Vous n’aviez pas le ',true);layers.content.addObject(objs.obj262);objs.obj263=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'droit de vous en prendre à ',true);layers.content.addObject(objs.obj263);objs.obj264=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'elle. ',true);layers.content.addObject(objs.obj264);objs.obj265=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - T’avais qu’à pas te mêler ',true);layers.content.addObject(objs.obj265);objs.obj266=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de nos affaires.',true);layers.content.addObject(objs.obj266);objs.obj267=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Quatre contre un, vous ',true);layers.content.addObject(objs.obj267);objs.obj268=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'n’êtes que des lâches !',true);layers.content.addObject(objs.obj268);objs.obj269=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon avait lancé ça tout en ',true);layers.content.addObject(objs.obj269);objs.obj270=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'jetant un bref coup d’œil ',true);layers.content.addObject(objs.obj270);objs.obj271=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'autour de lui. Il avait aperçu ',true);layers.content.addObject(objs.obj271);objs.obj272=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'la grosse pierre au pied du ',true);layers.content.addObject(objs.obj272);objs.obj273=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'grillage. Un bon tremplin…',true);layers.content.addObject(objs.obj273);objs.obj274=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Kevin fulminait. ',true);layers.content.addObject(objs.obj274);objs.obj275=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Amenez-le moi ! ',true);layers.content.addObject(objs.obj275);objs.obj276=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Les trois autres s’élancèrent. ',true);layers.content.addObject(objs.obj276);objs.obj277=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Mais, juste avant que leurs ',true);layers.content.addObject(objs.obj277);objs.obj278=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'mains ne se referment sur ',true);layers.content.addObject(objs.obj278);objs.obj279=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'lui, il s’était jeté sur le côté. ',true);layers.content.addObject(objs.obj279);objs.obj280=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'D’une roulade il avait atteint ',true);layers.content.addObject(objs.obj280);objs.obj281=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'la pierre. Il se redressa d’un ',true);layers.content.addObject(objs.obj281);objs.obj282=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'bond, prit appui sur le rocher ',true);layers.content.addObject(objs.obj282);objs.obj283=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'et entreprit l’escalade du ',true);layers.content.addObject(objs.obj283);objs.obj284=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'grillage.',true);layers.content.addObject(objs.obj284);objs.obj285=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Il va s’échapper ! Faites ',true);layers.content.addObject(objs.obj285);objs.obj286=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'quelque chose !',true);layers.content.addObject(objs.obj286);objs.obj287=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},' - Mais… Il ne peut pas aller ',true);layers.content.addObject(objs.obj287);objs.obj288=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'loin, il n’y a rien après.',true);layers.content.addObject(objs.obj288);objs.obj289=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'C’était vrai.',true);layers.content.addObject(objs.obj289);objs.obj290=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Il n’y avait plus rien. Rien ',true);layers.content.addObject(objs.obj290);objs.obj291=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'d’autre qu’un énorme trou ',true);layers.content.addObject(objs.obj291);objs.obj292=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'de ténèbres. ',true);layers.content.addObject(objs.obj292);objs.obj293=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Mais il était trop tard pour ',true);layers.content.addObject(objs.obj293);objs.obj294=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'reculer. ',true);layers.content.addObject(objs.obj294);objs.obj295=new mse.Text(layers.content,{size:[coords.cid37,coords.cid18]},'Simon s’élança dans le vide.',true);layers.content.addObject(objs.obj295);layers.content.setDefile(1300);temp.layerDefile=layers.content;pages.Content.addLayer('content',layers.content);var action={};var reaction={};action.ShowFouine=[{src:objs.obj54,type:'show'}];reaction.ShowFouine=function(){ animes.fouine.start(); };mse.Script.register(action.ShowFouine,reaction.ShowFouine);action.transAide=[{src:objs.obj5,type:'click'}];reaction.transAide=function(){ root.transition(pages.Aide); };mse.Script.register(action.transAide,reaction.transAide);action.transCha=[{src:objs.obj566,type:'click'}];reaction.transCha=function(){ root.transition(pages.Chapitre); };mse.Script.register(action.transCha,reaction.transCha);action.transCont=[{src:pages.Chapitre,type:'click'}];reaction.transCont=function(){ root.transition(pages.Content); };mse.Script.register(action.transCont,reaction.transCont);mse.currTimeline.start();};createbook();