...
mse.src.addSource('decor','game/Resources/decorM.png', 'image', true);
...
function createbook(){
	mse.configs.srcPath='./Voodoo_Ch11/';
	window.root = new mse.Root('Voodoo_Ch11',mse.coor('cid0'),mse.coor('cid1'),'portrait');
	var temp = {};
	...
	objs.obj60=new Escape(); layers.aree.addGame(objs.obj60);
