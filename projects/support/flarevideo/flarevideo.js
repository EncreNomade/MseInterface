...
$.fn.idleTimer = function(options){
  ...
  var idle     = false;  
  var timeout  = options.timeout  || 2000; // 3 seconds
...
FlareVideo.fn.close = function(){
  this.stop();
  this.element.fadeOut();
};
FlareVideo.fn.hide = function(){
  this.element.css('display','none');
};
FlareVideo.fn.show = function(){
...
*/
FlareVideo.fn.setupClose = function() {
  var close = $("<div />");
